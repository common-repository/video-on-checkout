...
abstract class Video_On_Checkout_Settings_Base extends Video_On_Checkout_Root
{
	...
	public function opt_set( $key, $value )
	{
		return update_option( $this->plugin_id_ . '_' . $key, $value );
	}

	public function opt( $key )
	{
		$opt = $this->opts_meta( $key );
		$k2  = $this->plugin_id_ . "_" . $key;
